<div
    class="flex flex-col flex-1 w-full px-6 py-4 space-y-3 overflow-auto bg-white shadow lg:shadow-none lg:relative lg:left-auto sm:px-8 lg:py-8 sm:space-y-4">
                ...
                <div class="flex gap-1 lg:flex-wrap snap-x lg:snap-none">
                    @foreach ($group['questions'] as $question)
                        <x-button wire:click="setQuestion('{{ $group['id'] }}','{{ $question['id'] }}')" square
                            radius="rounded-full" base="!p-0 snap-start lg:snap-none w-10 lg:w-12" size="sm"
