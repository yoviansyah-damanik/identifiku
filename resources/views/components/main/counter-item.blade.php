<div class="[perspective:800px] group cursor-pointer">
    <div
        ...
        <div
            class="[backface-visibility:hidden] [transform:rotateY(.5turn)] absolute inset-0 px-4 py-12 bg-gradient-to-br from-primary-500 to-primary-950 text-white text-center grid place-items-center rounded-xl">
            {{ $description }}
        </div>
    </div>
</div>
