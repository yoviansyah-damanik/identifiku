<div class="[perspective:800px] group cursor-pointer">
    <div
        ...
        <div
            class="[backface-visibility:hidden] overflow-hidden absolute inset-0 px-4 py-6 lg:py-12 bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl flex flex-col items-center justify-center">
        ...
        <div
            class="[backface-visibility:hidden] overflow-hidden [transform:rotateY(.5turn)] absolute inset-0 px-4 py-6 lg:py-12 bg-gradient-to-br from-primary-500 to-primary-700 text-secondary-50 text-center grid place-items-center rounded-xl">
            <div class="z-[1]">
                {{ $description }}
            </div>
            <div
