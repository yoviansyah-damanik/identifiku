<div class="flex flex-col lg:h-full lg:flex-row">
    <div class="relative flex flex-col shadow lg:h-[calc(100dvh_-_88px)] lg:w-80 xl:w-96">
        ...
        {{-- GROUPS --}}
        <x-assessment.step.calculation-2.group :groups="$questions" :$questionActive :$result />
        {{-- END GROUPS --}}
    </div>
    ...
    <div
        ...
        {{-- ACTIVE QUESTION --}}
        <x-assessment.step.calculation-2.question :$questionActive :$result :$calculationAnswers />
        {{-- END ACTIVE QUESTION --}}
