<div x-data="{ loading: false }" x-show="loading" @loading.window="loading = $event.detail.loading;">
    <div
        class="fixed z-loading-state top-3 left-1/2 -translate-x-1/2 shadow-md overflow-hidden bg-primary-50 flex items-center justify-center rounded-full gap-3">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 aspect-square" viewBox="0 0 200 200" class="pencil">
            <defs>
        ...
        <h2 class="text-center text-primary-500 dark:text-fuchsia-600 font-semibold pr-5">{{ __('Loading') }}...</h2>
    </div>
</div>
