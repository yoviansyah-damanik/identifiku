<div>
    <x-modal.body>
        <div class="mb-6 space-y-3 sm:space-y-4">
            <x-form.input :loading="$isLoading" :label="__(':name Name', ['name' => __('Education Level')])" block :placeholder="__('Entry :entry', ['entry' => __(':name Name', ['name' => __('Education Level')])])" type='text'
