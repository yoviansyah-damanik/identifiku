<x-content>
    <ol
        ...
        @foreach ($steps as $item)
            <li @class([
                'flex items-center justify-center flex-1 p-4 cursor-not-allowed',
    ...
    <div class="flex flex-col max-w-screen-xl gap-6 p-6 mx-auto bg-white rounded-lg sm:p-8 lg:flex-row sm:gap-8">
