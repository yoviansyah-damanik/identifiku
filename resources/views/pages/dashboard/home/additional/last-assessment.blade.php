<div>
    @if ($assessment)
        <div
            class="relative flex items-center gap-5 mb-5 text-2xl font-bold text-center uppercase border-secondary-50 text-nowrap text-secondary-500 before:border-b before:inline-flex before:w-full before:border-secondary-500 after:border-secondary-500 after:border-b after:inline-flex after:w-full">
            {{ __('Last Assessment') }}
        </div>
