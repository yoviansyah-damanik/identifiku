...
namespace App\Livewire\Assessment\Step\StepTwo;
...
class Index extends Component
{
    ...
    {
        return view('pages.assessment.step.step-two.index');
    }
    ...
    // {
    //     $answers = $this->assessment->details->where('question_id', $this->questionActive['id']);
    ...
    // public function setAnswer(string $question, AnswerChoice|string $answer, ?int $score = null)
    // {
    //     if (is_string($answer)) {
    //         $answer = AnswerChoice::find($answer);
    //     }
    ...
    //                     $newDetails = $question->answers->map(fn($answer) =>
    //                     [
    //                         'assessment_id' => $this->assessment->id,
    //                         'question_id' => $question->id,
    //                         'answer_choice_id' => $answer->id,
